...
export default function Resume() {
  return (
    <Grid className={globalStyle.toString()}>
      ...
      <Section title="Brief">
        <p>
          I am Kostas Bariotis, a software engineer from Thessaloniki, Greece. I am passionate about
          clean code and an advocate of that success is in the detail. I am interested in designing
          software architectures, APIs and databases to serve the rest of an application. My career
          path started with building e-commerce projects using various known platforms like Magento
          and Wordpress. After I gained the knowledge of how complete software systems work, I
          started working with startups companies where we were building our own product. I have
          worked with various languages (but mostly Javascript), databases (RDBMSes and NoSQL) and
          built monolithic applications as well as distributed systems.
        </p>
      </Section>
      ...
      <Section title="Open source">
        ...
        <p>
          ...
          the years. You can find my publicly available talks over at ​Slides​. I am also constantly
          writing on my blog​ about my experiences with those technologies.
        </p>
        <p>
