...
export default function Contact({ data }) {
  return (
    <IndexLayout>
      ...
      <main role="main">
        <p>
          I am a product engineer with over ten years of experience in early
          stage companies. I can help you design your business infrastructure
          and your development team management process. I can help you set your
          testing strategy and build your application
          {"'"}s architecture.
        </p>
        <p>
          Regarding the stack, I am currently working extensively with
          Javascript/Node.js and React.js to build robust web applications and
          services. My I/P/F-aaS of preference is AWS.
        </p>
        ...
        <p>
          ...
          <a href="https://www.linkedin.com/pub/kostas-bariotis/81/b74/2a8">
            LinkedIn profile
          </a>
        ...
        <p>
          <b>
            I am currently available to hire for a limited time of work per
            week.
          </b>
        </p>
        <p>
