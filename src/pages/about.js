        ...
        <main role="main">
          <AboutSection title={'Intro'}>
            <p>
              ...
              application. I am a full stack engineer but I love taking a specific field in my hands
              and getting the juice out of it. I am always interested in being a part of a team that
            ...
            <p>
              ...
              <a rel="noopener noreferrer" href="http://devit.org" target="_blank">
                DEVit Conf
              </a>, the biggest web development conference in northern Greece. We are also known as{' '}
          ...
          <AboutSection title={'Bio'}>
            <BioEntry year={'2018'}>
              Started working with <a href="https://geekbot.io">Geekbot</a>, a fully remote company
              with a mission to change the way we do standup meetings.
            </BioEntry>
            <BioEntry year={'2017'}>
              Started working with <a href="https://quotelier.com">Quotelier</a>. A amazing product
